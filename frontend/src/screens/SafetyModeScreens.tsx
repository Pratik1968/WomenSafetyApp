...
export function SafetyModeVoiceCard() {
  ...
  // During an active journey, JourneyContext owns keyword detection — we just read its state
...
export function JourneyActiveScreen({
  ...
  // Emergency overlay state from JourneyContext
...
export function SafetyModeScreen({
  ...
  // Collect journey config across the wizard steps
