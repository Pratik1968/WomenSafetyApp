    ...
    <View style={styles.activeScreen}>
      <View style={styles.activeContent}>
        ...
        <View style={styles.footerActions}>
          <Pressable style={styles.callPoliceBtn}>
            <PhoneCall size={19} color={colors.emergencyForeground} strokeWidth={2} />
...
const styles = StyleSheet.create({
  ...
  callPoliceText: { fontSize: 17, fontWeight: "700", color: colors.emergencyForeground },
  endEmergencyBtn: {
    height: 56,
    backgroundColor: colors.background,
    borderRadius: radii.xl,
